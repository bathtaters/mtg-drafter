...
const Page: NextPage<GameHistoryServerSideProps> = (props: InferGetServerSidePropsType<typeof getServerSideProps>) => <GameHistory {...props} />

export const getServerSideProps = async (ctx: GetServerSidePropsContext) => handler(ctx).then((props) => ({ props }))
