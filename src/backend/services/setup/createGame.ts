...
export async function newBoosterGame({ packList, includeBasics, ...options }: BoosterOptions, hostSessionId?: string) {
  const packs = await buildBoosterPacks(packList, options.playerCount, includeBasics)
