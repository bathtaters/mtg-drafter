...
const logParams = {
  ...
  size: z
    ...
    .default(logFetchOptions.minSize),
  filter: parseJson(
    z.object({
      ...logOptionsSchema,
      players: z.array(z.string().cuid2()).optional(),
      actions: z
        .array(z.nativeEnum(LogAction))
        .max(Object.keys(LogAction).length)
        .optional(),
    }),
    z.string().optional()
  ).optional(),
...
export type LogParams = {
  [Param in keyof typeof logParams]?: z.infer<(typeof logParams)[Param]>;
};
