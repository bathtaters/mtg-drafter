...
const SiteLink = ({
  ...
  <Link
    href={href}
    title={title}
    className={`link link-primary link-hover inline-flex items-center ${className}`}
    target="_blank"
  ...
  return (
    <FooterWrapperStyle>
      ...
      <div className="text-2xs leading-tight font-thin opacity-80 italic">
        ...
        <p>
          It is not approved/endorsed by Wizards. Portions of the materials used
          are property of Wizards of the Coast
        </p>
        <p>
          We only use strictly necessary cookies and do not share any data with
          third parties.
        </p>
      </div>
    </FooterWrapperStyle>
