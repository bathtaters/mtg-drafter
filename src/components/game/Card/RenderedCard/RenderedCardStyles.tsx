...
export const splitLayouts: { [layout in Layout]?: LayoutData } = {
  split: [
    " left-[15%] -rotate-90 " + splitRatios.join(" "),
    " -bottom-[9%]",
    " -top-[9%]",
    false,
    false,
  ...
  aftermath: [
    "",
    " top-[1%] w-full h-1/2",
    " -bottom-[9%] left-[15%] rotate-90 " + splitRatios.join(" "),
    true,
    false,
  ],
...
export const Border = ({
  ...
  <div
    className={`absolute top-0${hide ? "" : " bg-black"} text-black rounded-card w-full h-full${
...
export const CardBgd = ({ color }: { color?: string | false }) =>
  !color ? null : (
    <div
      className={`absolute top-[2.5%] left-[4%] w-[92%] h-[95%] z-0 ${color}`}
    />
  );
...
export const ArtBox: Style = ({ children }) => (
  <div className="relative col-span-2 my-0 mx-[4%] bg-zinc-300">{children}</div>
);
...
export const Footer: Style = ({ children }) => (
  <>
    <div />
    <div
      className="flex justify-center items-center mt-[4%] mr-[15%]
...
export const Name: Style = ({ children }) => (
  <span className="text-[0.9em] font-bold self-start mt-[0.2em] z-[1] text-left leading-[0.9em]">
    {children}
  </span>
);
...
export const Mana: Style = ({ html = "" }) => (
  <span
    className="text-[0.78em] whitespace-nowrap z-[1] text-left leading-[0.9em]"
    dangerouslySetInnerHTML={{ __html: html }}
  />
);

export const Subtitle: Style = ({ children }) => (
  <div className="absolute top-0 left-2 text-sm text-gray-700 text-center">
    {children}
  </div>
);
...
export const Type: Style = ({ children }) => (
  <span className="text-[0.7em] font-bold text-shadow-card shadow-black/25 z-[1] text-left leading-[0.9em]">
    {children}
  </span>
);
...
export const Rarity: Style = ({ className = "", children }) => (
  <span
    className={`text-[0.6em] text-shadow-icon shadow-black/45 opacity-[0.85] z-[1] text-left leading-[0.9em] ${className}`}
  >
    {children}
  </span>
);
...
export const TextBox: Style = ({ children }) => (
  <div className="col-span-2 flex overflow-y-visible overflow-x-auto m-[1%] py-[1%] px-[2%] text-[0.75em] text-left bg-white/95 shadow-inset pointer-events-auto">
    <div className="z-[1] text-left leading-[0.9em] my-auto mx-0">
      {children}
    </div>
  </div>
);
...
export const TextLine: Style = ({ html = "" }) => (
  <p
    className="text-shadow-card shadow-black/25 mt-0 mb-[0.4em] leading-[1.15em]"
    dangerouslySetInnerHTML={{ __html: html }}
  />
);
...
export const ArtMainText: Style = ({ small, children }) => (
  <div
    className={`flex flex-col justify-center items-center h-full ${
      small ? "text-[1em]" : "text-[1.8em]"
    } font-sans leading-[1.3em] text-zinc-700/60`}
  >
    {children}
  </div>
);
...
export const ArtSubText: Style = ({ children }) => (
  <div
    className={`absolute top-[1%] right-[2%] text-[0.7em] italic text-black/50 font-sans`}
  >
    {children}
  </div>
);
