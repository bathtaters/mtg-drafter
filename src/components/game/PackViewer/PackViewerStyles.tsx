...
export const ErrorContainer = (props: HTMLProps<HTMLDivElement>) => <div className="badge badge-error" {...props} />

// Input elements

export const ViewPackButton = ({ error, isLoading, ...props }: Parameters<typeof RoundButton>['0'] & { error?: string, isLoading?: boolean }) => (
    <div className="flex flex-col items-center">
        <RoundButton {...props} />
        {error && <ErrorContainer>{error}</ErrorContainer>}
        {isLoading && <div className="loading loading-dots loading-sm text-secondary" />}
    </div>
)
