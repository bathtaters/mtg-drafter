...
export const ExportIcon = ({ className = "w-6" }: { className?: string }) => (
  <svg
    ...
    className={`fill-current h-auto ${className}`}
    viewBox="0 0 24 24"
  >
    <path
      d="M11.293 2.293a1 1 0 0 1 1.414 0l4 4a1 1 0 0 1-1.414 1.414L13 5.414V16a1 1 0 1 1-2 0
...
export const ToolsIcon = ({ className = "w-6" }: { className?: string }) => (
  <GearIcon className={`fill-current h-auto ${className}`} />
);
