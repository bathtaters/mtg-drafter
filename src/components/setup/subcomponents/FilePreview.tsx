...
export default function FilePreview({ file, clearFile }: Props) {
  return (
    <PreviewContainer>
      ...
      <TextPad
        showArrow={false}
        className="object-cover w-16 h-16 p-1 rounded-full bg-secondary fill-secondary-content"
      />
