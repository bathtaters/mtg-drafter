  ...
  return (
    <InputWrapper>
      <FieldWrapper label="Options">
        <RangeInput
          caption={<PlayersLabel />}
          value={options.players}
          setValue={setOption.players}
          {...setupLimits.players}
        />
        <RangeInput
          caption={<PacksLabel />}
          value={options.packs}
          setValue={setOption.packs}
          {...setupLimits.packs}
        />
        <RangeInput
          caption={<PackSizeLabel />}
          value={options.packSize}
          setValue={setOption.packSize}
          {...setupLimits.packSize}
        />
        <RangeInput
          caption={<TimerLabel />}
          value={options.timer}
          setValue={setOption.timer}
          {...setupLimits.timer}
          keys={timerText}
          boxClass="w-16"
          wrapperClass="px-4 pb-4 w-full tooltip-bottom"
        />
      </FieldWrapper>
      ...
      <FieldWrapper label="Cube File">
        ...
        {fileLoading ? (
          ...
          <FileInput
            fileMimeType={fileSettings.type}
